...
function setAdminPowerTreeData(){
    return [
        ...
        { id:'articleManage_content', pId:'contentManage', name:"文章管理", open:true},
        { id:'articleManage_content_add', pId:'articleManage_content', name:"新增"},
        { id:'articleManage_content_view', pId:'articleManage_content', name:"查看"},
        { id:'articleManage_content_modify', pId:'articleManage_content', name:"修改"},
        { id:'articleManage_content_del', pId:'articleManage_content', name:"删除"},

        { id:'articleManage_cateGory', pId:'contentManage', name:"文章类别管理", open:true},
        { id:'articleManage_cateGory_add', pId:'articleManage_cateGory', name:"新增"},
        { id:'articleManage_cateGory_view', pId:'articleManage_cateGory', name:"查看"},
        { id:'articleManage_cateGory_modify', pId:'articleManage_cateGory', name:"修改"},
        { id:'articleManage_cateGory_del', pId:'articleManage_cateGory', name:"删除"},

        { id:'newsManage', pId:'contentManage', name:"新闻管理", open:true},
        { id:'newsManage_add', pId:'newsManage', name:"新增"},
        { id:'newsManage_view', pId:'newsManage', name:"查看"},
        { id:'newsManage_modify', pId:'newsManage', name:"修改"},
        { id:'newsManage_del', pId:'newsManage', name:"删除"},
        ...
        { id:'TenderManage', pId:0, name:"招投标管理", open:true},
        { id:'TenderManage_add', pId:'TenderManage', name:"新增招投标"},
        { id:'TenderManage_view', pId:'TenderManage', name:"查看"},
        { id:'TenderManage_modify', pId:'TenderManage', name:"修改"},
        { id:'TenderManage_del', pId:'TenderManage', name:"删除"},
        { id:'complainManage_add', pId:'TenderManage', name:"新增投诉"},
        { id:'complainManage_view', pId:'TenderManage', name:"查看投诉"},
        { id:'complainManage_modify', pId:'TenderManage', name:"修改投诉"},
        { id:'complainManage_del', pId:'TenderManage', name:"删除投诉"},

        { id:'withdrawCashManage', pId:0, name:"提现", open:true},
        { id:'withdrawCashManage_add', pId:'withdrawCashManage', name:"新增提现"},
        { id:'withdrawCashManage_view', pId:'withdrawCashManage', name:"查看"},
        { id:'withdrawCashManage_modify', pId:'withdrawCashManage', name:"修改"},
        { id:'withdrawCashManage_del', pId:'withdrawCashManage', name:"删除"},

        { id:'userManage_user', pId:'userManage', name:"注册用户管理", open:true},
        { id:'userManage_user_add', pId:'userManage_user', name:"新增普通用户"},
        ...
        { id:'userManage_verify', pId:'userManage', name:"信息审核", open:true},
        { id:'userManage_verify_view', pId:'userManage_verify', name:"查看"},
        { id:'userManage_verify_modify', pId:'userManage_verify', name:"修改"},
        { id:'userManage_verify_del', pId:'userManage_verify', name:"删除"},

        { id:'ebookManage', pId:0, name:"数字期刊", open:true},
        { id:'ebookManage_add', pId:'ebookManage', name:"新增"},
        { id:'ebookManage_view', pId:'ebookManage', name:"查看"},
        { id:'ebookManage_modify', pId:'ebookManage', name:"修改"},
        { id:'ebookManage_del', pId:'ebookManage', name:"删除"},
        { id:'baoxiuManage', pId:0, name:"报修", open:true},
        { id:'baoxiuManage_add', pId:'baoxiuManage', name:"新增"},
        { id:'baoxiuManage_view', pId:'baoxiuManage', name:"查看"},
        { id:'baoxiuManage_modify', pId:'baoxiuManage', name:"修改"},
        { id:'baoxiuManage_del', pId:'baoxiuManage', name:"删除"},
        { id:'jianyiManage', pId:0, name:"建议", open:true},
        { id:'jianyiManage_add', pId:'jianyiManage', name:"新增"},
        { id:'jianyiManage_view', pId:'jianyiManage', name:"查看"},
        { id:'jianyiManage_modify', pId:'jianyiManage', name:"修改"},
        { id:'jianyiManage_del', pId:'jianyiManage', name:"删除"},

        { id:'vrManage', pId:0, name:"VR展馆", open:true},
        { id:'vrManage_add', pId:'vrManage', name:"新增"},
        { id:'vrManage_view', pId:'vrManage', name:"查看"},
        { id:'vrManage_modify', pId:'vrManage', name:"修改"},
        { id:'vrManage_del', pId:'vrManage', name:"删除"},

        { id:'rcdManage', pId:0, name:"推荐管理", open:true},
        { id:'rcdManage_add', pId:'rcdManage', name:"新增"},
        { id:'rcdManage_view', pId:'rcdManage', name:"查看"},
        { id:'rcdManage_modify', pId:'rcdManage', name:"修改"},
        { id:'rcdManage_del', pId:'rcdManage', name:"删除"},

        { id:'prcdManage', pId:0, name:"精准推广", open:true},
        { id:'prcdManage_add', pId:'prcdManage', name:"新增"},
        { id:'prcdManage_view', pId:'prcdManage', name:"查看"},
        { id:'prcdManage_modify', pId:'prcdManage', name:"修改"},
        { id:'prcdManage_del', pId:'prcdManage', name:"删除"},

        { id:'promotionManage', pId:0, name:"推广管理", open:true},
        { id:'promotionManage_add', pId:'promotionManage', name:"新增"},
        { id:'promotionManage_view', pId:'promotionManage', name:"查看"},
        { id:'promotionManage_modify', pId:'promotionManage', name:"修改"},
        { id:'promotionManage_del', pId:'promotionManage', name:"删除"},
        { id:'slideManage', pId:'promotionManage', name:"轮播图管理", open:true},
        { id:'slideManage_add', pId:'slideManage', name:"新增"},
        { id:'slideManage_view', pId:'slideManage', name:"查看"},
        { id:'slideManage_modify', pId:'slideManage', name:"修改"},
        { id:'slideManage_del', pId:'slideManage', name:"删除"},
        { id:'searchRcdManage', pId:'promotionManage', name:"搜索推荐管理", open:true},
        { id:'searchRcdManage_add', pId:'searchRcdManage', name:"新增"},
        { id:'searchRcdManage_view', pId:'searchRcdManage', name:"查看"},
        { id:'searchRcdManage_modify', pId:'searchRcdManage', name:"修改"},
        { id:'searchRcdManage_del', pId:'searchRcdManage', name:"删除"},
        { id:'categorySettingMng', pId:'promotionManage', name:"二级栏目设置", open:true},
        { id:'categorySettingMng_add', pId:'categorySettingMng', name:"新增"},
        { id:'categorySettingMng_view', pId:'categorySettingMng', name:"查看"},
        { id:'categorySettingMng_modify', pId:'categorySettingMng', name:"修改"},
        { id:'categorySettingMng_del', pId:'categorySettingMng', name:"删除"},        
...
function getArticleCategoryData($scope,$http){
    $http.get("/admin/manage/articleCategorys/list").success(function(result){
