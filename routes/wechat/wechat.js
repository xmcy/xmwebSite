...
router.get('/getHomeInfo', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'getHomeInfo', {
    title: '欢迎来到幸福天地!',
    page: 'getHomeInfo'
  })
})
router.get('/weActivity', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'weActivity', {
    title: '欢迎来到幸福天地!',
    page: 'weActivity'
  })
})
router.get('/weActivityNext', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'weActivityNext', {
    title: '欢迎来到幸福天地!',
    page: 'weActivityNext'
  })
})
router.get('/weDetailFix', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'weDetailFix', {
    title: '欢迎来到幸福天地!',
    page: 'weDetailFix'
  })
})
router.get('/weFixList', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'weFixList', {
    title: '欢迎来到幸福天地!',
    page: 'weFixList'
  })
})
router.get('/weForgetPassword', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'weForgetPassword', {
    title: '欢迎来到幸福天地!',
    page: 'weForgetPassword'
  })
})
router.get('/weAboutOus', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'weAboutOus', {
    title: '欢迎来到幸福天地!',
    page: 'weAboutOus'
  })
})
router.get('/weMagazine', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'weMagazine', {
    title: '欢迎来到幸福天地!',
    page: 'weMagazine'
  })
})
router.get('/weMakeDetail', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'weMakeDetail', {
    title: '欢迎来到幸福天地!',
    page: 'weMakeDetail'
  })
})
router.get('/weMakeList', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'weMakeList', {
    title: '欢迎来到幸福天地!',
    page: 'weMakeList'
  })
})
...
router.get('/wePriceList', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'wePriceList', {
    title: '欢迎来到幸福天地!',
    page: 'weMakeDetail'
  })
})
router.get('/weRegister', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'weRegister', {
    title: '欢迎来到幸福天地!',
    page: 'weRegister'
  })
})
router.get('/resourceRelease', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'resourceRelease', {
    title: '欢迎来到幸福天地!',
    page: 'resourceRelease'
  })
})
router.get('/love', function (req, res, next) {
  wechatFunc.renderToTargetPageByType(req, res, 'love', {
    title: '欢迎来到幸福天地!',
    page: 'love'
  })
})
...
router.get('/userCenter', function (req, res, next) {
  if (isLogined(req)) {
    wechatFunc.renderToTargetPageByType(req, res, 'userCenter', {
      title: '欢迎来到幸福天地！',
      page: ''
    })
  } else {
...
router.get('/weChangeMyFix', function (req, res) {
  if (isLogined(req)) {
    wechatFunc.renderToTargetPageByType(req, res, 'weChangeMyFix', {
      title: '欢迎来到幸福天地！',
      page: ''
    })
  } else {
...
router.get('/weICanFix', function (req, res, next) {
  if (isLogined(req)) {
    wechatFunc.renderToTargetPageByType(req, res, 'weICanFix', {
      title: '欢迎来到幸福天地！',
      page: ''
    })
  } else {
...
router.get('/weIprice', function (req, res, next) {
  if (isLogined(req)) {
    wechatFunc.renderToTargetPageByType(req, res, 'weIprice', {
      title: '欢迎来到幸福天地！',
      page: ''
    })
  } else {
...
router.post('/getChildType', function (req, res, next) {
  var currentCateList = ContentCategory.find({
...
router.post('/InsertAdvice', function (req, res, next) {
  var phoneNumArr = ['17771898882', '15927095400', '13871312213', '18571557923', '18871176855', '15927582796', '15827337859', '13971625508', '13554431451','18627992681','15827376637','18627992681']
